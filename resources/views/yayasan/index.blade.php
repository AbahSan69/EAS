    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                ...
                <div class="row g-3">
                    <div class="col-md-2">
                        <a href="{{ route('yayasan.bisnis.digital_organisasi.show', $pts->id) }}" 
                            class="text-decoration-none">
                            <div class="block block-rounded text-center p-3 bg-body-light hover-shadow">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('yayasan.bisnis.bisnis_inovasi.show', $pts->id) }}" 
                            class="text-decoration-none">
                            <div class="block block-rounded text-center p-3 bg-body-light hover-shadow">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('yayasan.bisnis.accountability.show', $pts->id) }}" 
                            class="text-decoration-none">
                            <div class="block block-rounded text-center p-3 bg-body-light hover-shadow">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('yayasan.bisnis.produk.show', $pts->id) }}" 
                            class="text-decoration-none">
                            <div class="block block-rounded text-center p-3 bg-body-light hover-shadow">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('yayasan.bisnis.constrain.show', $pts->id) }}" 
                            class="text-decoration-none">
                            <div class="block block-rounded text-center p-3 bg-body-light hover-shadow">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('yayasan.bisnis.risk.show', $pts->id) }}" 
                            class="text-decoration-none">
                            <div class="block block-rounded text-center p-3 bg-body-light hover-shadow">
