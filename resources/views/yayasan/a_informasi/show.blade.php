...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
    <form action="{{ route('yayasan.informasi.show', $id_pts) }}" method="GET">
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">List Architecture Informasi </h3>
              ...
              @foreach ($informasi as $list_informasi)
                <tbody>
                  <tr>
                    ...
                    <td>
                      @if($list_informasi->latestHistory->image)
                        <div class="image-preview" data-bs-toggle="modal" data-bs-target="#imageModal-{{ $list_informasi->id }}">
                          <img src="{{ asset($list_informasi->latestHistory->latestHistory->image) }}" 
                          alt="gambar" 
                          width="80" 
                          class="img-thumbnail">
                    ...
                    <td class="text-center">
                      <button type="button" class="btn btn-sm btn-alt-warning js-bs-tooltip-enabled me-2" title="Comment" data-bs-toggle="modal" data-bs-target="#modal-block-vcenter-extra-large-komentar-{{ $list_informasi->id }}">
                ...
                <!-- Modal -->
                <div class="modal fade" id="imageModal-{{ $list_informasi->id }}" tabindex="-1">
                    ...
                    <div class="modal-content">
                      <div class="block block-rounded block-transparent mb-0">
                        ...
                        <div class="block-content fs-sm">
                          ...
                          <form class="space-y-4" action="{{ route('yayasan.informasi.save_comment') }}" method="POST">
                          @csrf
