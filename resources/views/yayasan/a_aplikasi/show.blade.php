...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
    <form action="{{ route('yayasan.aplikasi.show', $id_pts) }}" method="GET">
              ...
              @foreach ($aplikasi as $list_aplikasi)
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                      <button type="button" class="btn btn-sm btn-alt-warning js-bs-tooltip-enabled me-2" title="Comment" data-bs-toggle="modal" data-bs-target="#modal-block-vcenter-extra-large-komentar-{{ $list_aplikasi->id }}">
                ...
                <!-- Modal -->
                <div class="modal fade" id="imageModal-{{ $list_aplikasi->id }}" tabindex="-1">
                    ...
                    <div class="modal-content">
                      <div class="block block-rounded block-transparent mb-0">
                        ...
                        <div class="block-content fs-sm">
                          ...
                          <form class="space-y-4" action="{{ route('yayasan.aplikasi.save_comment') }}" method="POST">
                          @csrf
