...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
          <form action="{{ route('yayasan.bisnis.accountability.show', $id_pts) }}" method="GET">
                            ...
                            <td>
                              @if($list_accountability->latestHistory->image)
                                <div class="image-preview" data-bs-toggle="modal" data-bs-target="#imageModal-{{ $list_accountability->id }}">
                                  <img src="{{ asset($list_accountability->latestHistory->latestHistory->image) }}" 
                                  alt="gambar" 
                                  width="80" 
                                  class="img-thumbnail">
                          ...
                          <td class="text-center">
                            <div class="btn-group">
                              <button type="button" class="btn btn-sm btn-alt-warning js-bs-tooltip-enabled me-2" title="Komentar" data-bs-toggle="modal" data-bs-target="#modal-block-vcenter-extra-large-komentar-{{ $list_accountability->id }}">
                                ...
                                <!-- Modal -->
                <div class="modal fade" id="imageModal-{{ $list_accountability->id }}" tabindex="-1">
...
@endforelse
                  ...
                  <form class="space-y-4" action="{{ route('yayasan.bisnis.accountability.save_comment') }}" method="POST">
                    @csrf
