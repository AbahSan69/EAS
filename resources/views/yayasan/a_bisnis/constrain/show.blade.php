...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
          <form action="{{ route('yayasan.bisnis.constrain.show', $id_pts) }}" method="GET">
          ...
          <div class="block block-rounded">
              <div class="block-header block-header-default">
                <h3 class="block-title">List Constrain </h3>
                            ...
                            <td>
                              @if($list_constrain->latestHistory->image)
                                <div class="image-preview" data-bs-toggle="modal" data-bs-target="#imageModal-{{ $list_constrain->id }}">
                                  <img src="{{ asset($list_constrain->latestHistory->latestHistory->image) }}" 
                                  alt="gambar" 
                                  width="80" 
                                  class="img-thumbnail">
...
@endforelse
                  ...
                  <form class="space-y-4" action="{{ route('yayasan.bisnis.constrain.save_comment') }}" method="POST">
                    @csrf
