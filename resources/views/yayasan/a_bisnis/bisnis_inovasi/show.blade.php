                  ...
                  <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                      <div class="modal-body text-center">
                        <img src="{{ asset('storage/'.$list_bisnis_inovasi->image) }}" class="img-fluid" alt="gambar detail">
                      </div>
                    </div>
                  </div>
                </div>
