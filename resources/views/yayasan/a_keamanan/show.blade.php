...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
    <form action="{{ route('yayasan.keamanan.show', $id_pts) }}" method="GET">
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">List Architecture Keamanan </h3>
              ...
              @foreach ($keamanan as $list_keamanan)
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                      <button type="button" class="btn btn-sm btn-alt-warning js-bs-tooltip-enabled me-2" title="Comment" data-bs-toggle="modal" data-bs-target="#modal-block-vcenter-extra-large-komentar-{{ $list_keamanan->id }}">
                ...
                <!-- Modal -->
                <div class="modal fade" id="imageModal-{{ $list_keamanan->id }}" tabindex="-1">
                    ...
                    <div class="modal-content">
                      <div class="block block-rounded block-transparent mb-0">
                        ...
                        <div class="block-content fs-sm">
                          ...
                          <form class="space-y-4" action="{{ route('yayasan.keamanan.save_comment') }}" method="POST">
                          @csrf
