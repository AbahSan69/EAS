...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
          <form action="{{ route('yayasan.vision.principle.show', $id_pts) }}" method="GET">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="block block-rounded block-transparent mb-0">
                <div class="block-header block-header-default">
                  <h3 class="block-title">Modal Komentar Principle</h3>
                  <div class="block-options">
...
@endforelse
                  ...
                  <form class="space-y-4" action="{{ route('yayasan.vision.principle.save_comment') }}" method="POST">
                    @csrf
