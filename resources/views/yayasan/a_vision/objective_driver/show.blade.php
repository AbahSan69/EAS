...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
          <form action="{{ route('yayasan.vision.objective_driver.show', $id_pts) }}" method="GET">
              <div class="input-group mb-4">
                <input type="text" class="form-control" name="search" placeholder="Cari Objective Drivers" value="{{ request()->input('search') }}">
          ...
          <div class="block block-rounded">
              <div class="block-header block-header-default">
                <h3 class="block-title">List Objective Driver</h3>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="block block-rounded block-transparent mb-0">
                <div class="block-header block-header-default">
                  <h3 class="block-title">Modal Komentar Objective Driver</h3>
                  <div class="block-options">
...
@endforelse
                  ...
                  <form class="space-y-4" action="{{ route('yayasan.vision.objective_driver.save_comment') }}" method="POST">
                    @csrf
