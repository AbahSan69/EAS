...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
          <form action="{{ route('yayasan.vision.bisnis.show', $id_pts) }}" method="GET">
              <div class="input-group mb-4">
                <input type="text" class="form-control" name="search" placeholder="Cari bisnis" value="{{ request()->input('search') }}">
                            ...
                            <td>
                              @if($list_bisnis->latestHistory->image)
                                <div class="image-preview" data-bs-toggle="modal" data-bs-target="#imageModal-{{ $list_bisnis->id }}">
                                  <img src="{{ asset($list_bisnis->latestHistory->latestHistory->image) }}" 
                                  alt="gambar" 
                                  width="80" 
                                  class="img-thumbnail">
...
@endforelse
                  ...
                  <form class="space-y-4" action="{{ route('yayasan.vision.bisnis.save_comment') }}" method="POST">
                    @csrf
