  ...
  <div class="content">
          <form action="{{ route('sp.ea.keamanan.show', $id_pts) }}" method="GET">
              <div class="input-group mb-4">
                <input type="text" class="form-control" name="search" placeholder="Cari keamanan" value="{{ request()->input('search') }}">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="bicument">
                          <div class="modal-content">
                            <div class="block block-rounded block-transparent mb-0">
                              ...
                              <div class="block-content fs-sm">
                                <form class="space-y-4" action="{{ route('sp.ea.keamanan.update') }}" method="POST">
                                @csrf
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="mb-4">
                                      ...
                                      <select class="form-select" id="status" name="status" required>
                                        ...
                                        <option value="Proses" {{ old('status', $list_keamanan->status ?? '') == 'Proses' ? 'selected' : '' }}>Proses</option>
                                        <option value="Selesai" {{ old('status', $list_keamanan->status ?? '') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                      </select>
                                    </div>
                                  </div>
                              </div>
