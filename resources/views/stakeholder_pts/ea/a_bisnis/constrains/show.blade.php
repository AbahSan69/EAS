...
<main id="main-container" class="flex-grow-1">
  ...
  <div class="content">
          <form action="{{ route('sp.ea.bisnis.constrain.show', $id_pts) }}" method="GET">
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="btn-group">
                              ...
                              <button type="button" class="btn btn-sm btn-alt-danger js-bs-tooltip-enabled" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete" title="Hapus" onclick="confirmationHapusData('{{ route('sp.ea.bisnis.constrain.delete', $list_constrain->id) }}')">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="constraincument">
                          <div class="modal-content">
                            <div class="block block-rounded block-transparent mb-0">
                              ...
                              <div class="block-content fs-sm">
                                <form class="space-y-4" action="{{ route('sp.ea.bisnis.constrain.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
          ...
          <div class="modal-dialog modal-dialog-centered" role="constraincument">
            <div class="modal-content">
              <div class="block block-rounded block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                  <form class="space-y-4" action="{{ route('sp.ea.bisnis.constrain.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
