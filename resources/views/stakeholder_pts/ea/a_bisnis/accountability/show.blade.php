                ...
                <div class="table-responsive">
                  <table class="table table-vcenter">
                    ...
                    @foreach ($bisnis as $list_accountability)
                      <tbody>
                        <tr>
                          ...
                          <td class="fw-semibold fs-sm">
                            ...
                            <td class="fw-semibold fs-sm">
                              @if ($list_accountability->content)
                                {{ $list_accountability->content }}
                              @else
                          ...
                          <td class="text-center">
                            <div class="btn-group">
                              ...
                              <button type="button" class="btn btn-sm btn-alt-danger js-bs-tooltip-enabled" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete" title="Hapus" onclick="confirmationHapusData('{{ route('sp.ea.bisnis.accountability.delete', $list_accountability->id) }}')">
                      ...
                      <!-- Modal Gambar -->
                      <div class="modal fade" id="imageModal-{{ $list_accountability->id }}" taaccountabilityndex="-1">
          ...
          <div class="modal-dialog modal-dialog-centered" role="bicument">
            <div class="modal-content">
              <div class="block block-rounded block-transparent mb-0">
                ...
                <div class="block-content fs-sm">
                  <form class="space-y-4" action="{{ route('sp.ea.bisnis.accountability.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
