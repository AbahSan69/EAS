                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                          <div class="modal-content">
                            <div class="modal-body text-center">
                              ...
                              <img src="{{ asset($list_risk->image) }}" class="img-fluid" alt="gambar detail">
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="bicument">
                          <div class="modal-content">
                            <div class="block block-rounded block-transparent mb-0">
                              ...
                              <div class="block-content fs-sm">
                                <form class="space-y-4" action="{{ route('sp.ea.bisnis.risk.update') }}" method="POST">
                                @csrf
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="mb-4">
                                      ...
                                      <select class="form-select" id="status" name="status" required>
                                        ...
                                        <option value="Proses" {{ old('status', $list_risk->status ?? '') == 'Proses' ? 'selected' : '' }}>Proses</option>
                                        <option value="Selesai" {{ old('status', $list_risk->status ?? '') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                      </select>
                                    </div>
                                  </div>
                              </div>
