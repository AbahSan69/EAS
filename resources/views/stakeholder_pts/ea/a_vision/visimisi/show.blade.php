                            ...
                            <td>
                              @if($list_visimisi->image)
                                <div class="image-preview" data-bs-toggle="modal" data-bs-target="#imageModal-{{ $list_visimisi->id }}">
                                  ...
                                  width="80" 
                                  class="img-thumbnail"> --}}
                                  <img src="{{ asset($list_visimisi->image) }}" 
                                  alt="gambar" 
                                  width="80" 
                                  class="img-thumbnail">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                          <div class="modal-content">
                            <div class="modal-body text-center">
                              ...
                              <img src="{{ asset($list_visimisi->image) }}" class="img-fluid" alt="gambar detail">
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="block block-rounded block-transparent mb-0">
                              ...
                              <div class="block-content fs-sm">
                                <form class="space-y-4" action="{{ route('sp.ea.vision.visimisi.update') }}" method="POST">
                                @csrf
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="mb-4">
                                      ...
                                      <select class="form-select" id="status" name="status" required>
                                        ...
                                        <option value="Proses" {{ old('status', $list_visimisi->status ?? '') == 'Proses' ? 'selected' : '' }}>Proses</option>
                                        <option value="Selesai" {{ old('status', $list_visimisi->status ?? '') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                      </select>
                                    </div>
                                  </div>
                              </div>
