                        ...
                        <div class="block block-rounded p-3 bg-body-light h-100">
                            ...
                            @if($informasi->isEmpty())
                                ...
                                <div class="text-center mt-3">
                                    <a href="{{ route('sp.ea.informasi.show', $pts->id) }}" class="btn btn-sm btn-primary">Lihat Detail</a>
                                </div>
                            @else
                                <div class="row g-2">
                    ...
                    <div class="col-md-3">
                        <div class="block block-rounded p-3 bg-body-light h-100">
                            ...
                            @if($aplikasi->isEmpty())
                                <p class="text-center text-muted">Data Kosong</p>
                                <div class="text-center mt-3">
                                    <a href="{{ route('sp.ea.aplikasi.show', $pts->id) }}" class="btn btn-sm btn-primary">Lihat Detail</a>
                                </div>
                            @else
                                <div class="row g-2">
                    ...
                    <div class="col-md-3">
                        <div class="block block-rounded p-3 bg-body-light h-100">
                            ...
                            @if($teknologi->isEmpty())
                                <p class="text-center text-muted">Data Kosong</p>
                                <div class="text-center mt-3">
                                    <a href="{{ route('sp.ea.teknologi.show', $pts->id) }}" class="btn btn-sm btn-primary">Lihat Detail</a>
                                </div>
                            @else
                                <div class="row g-2">
                    ...
                    <div class="col-md-3">
                        <div class="block block-rounded p-3 bg-body-light h-100">
                            ...
                            @if($keamanan->isEmpty())
                                <p class="text-center text-muted">Data Kosong</p>
                                <div class="text-center mt-3">
                                    <a href="{{ route('sp.ea.keamanan.show', $pts->id) }}" class="btn btn-sm btn-primary">Lihat Detail</a>
                                </div>
                            @else
                                <div class="row g-2">
