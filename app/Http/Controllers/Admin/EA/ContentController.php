...
class ContentController extends Controller
{
    ...
    public function index($id, $UniversityId, Request $request)
{
    $user = Auth::user();
    ...
    return view('admin.ea.university.content', [
        'subdomain' => $subdomain,
        'subkomponendetail' => $subdomain->component,
        'progress' => $subdomainProgress,
        'userPermissions' => $userPermissions,
    ...
    public function component_detail($id, Request $request)
{
    ...
    return view('admin.ea.university.content_detail', [
        'component' => $component,
        'search' => $search,
    ...
    public function stakeholder_detail($id, Request $request)
    {
        ...
        return view('admin.ea.university.stakeholder', compact('users', 'component'));
    }
    ...
    public function create($id)
    {
        ...
        return view('admin.ea.university.stakeholder_create_update', array_merge($data, [
    ...
    public function edit($id, $componentId)
{
    ...
    public function storeStakeholder(Request $request)
    {
        ...
        return redirect()->route('admin.ea.university.stakeholder', $request->component_id)->with('success', 'Stakeholder baru berhasil ditambahkan.');
    ...
    public function updateStakeholder(Request $request)
{
    ...
    return redirect()->route('admin.ea.university.stakeholder', $request->component_id)->with('success', 'Stakeholder baru berhasil diperbarui.');
}
